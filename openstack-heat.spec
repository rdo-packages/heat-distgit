...
%if 0%{rhosp} == 0
BuildRequires: python%{pydefault}-senlinclient
%endif
...
Requires: python%{pydefault}-debtcollector >= 1.2.0
...
Requires: python%{pydefault}-monascaclient >= 1.10.0
%endif
Requires: python%{pydefault}-openstacksdk >= 0.9.19
