...
Source0:        https://tarballs.openstack.org/%{service}/openstack-%{service}-%{upstream_version}.tar.gz
#
...
%changelog
* Thu Apr 02 2020 RDO <dev@lists.rdoproject.org> 1:11.0.3-1
- Update to 11.0.3
...
* Wed Aug 22 2018 RDO <dev@lists.rdoproject.org> 1:11.0.0-0.2.0rc1
