...
%if 0%{?with_python3}
# see https://github.com/rdo-packages/oslo-config-distgit/blob/rpm-master/python-oslo-config.spec#L178-L184
PYTHONPATH=. /usr/bin/python3-oslo-config-generator --config-file=config-generator.conf
%else
PYTHONPATH=. /usr/bin/oslo-config-generator --config-file=config-generator.conf
%endif
